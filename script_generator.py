...
def generate_script(topic: str, duration_minutes: int = 5, sophistication_level: int = 2) -> str:
    """
...
"""
    ...
    # Save script to a text file for review
    with open("math_script.txt", "w") as f:
        f.write(result)
    print("Script saved to math_script.txt")
...
if __name__ == "__main__":
    ...
    with open("test_narrator_script.txt", "w") as f:
        f.write(clean_text)
    print("Test narration script saved to test_narrator_script.txt")